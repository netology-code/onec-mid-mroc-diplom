...
1. В мобильном приложении из [практического задания к занятию 15-3](https://github.com/netology-code/onec-mid-homeworks/blob/main/MROC/homework-15-3.md) создайте документ «Доставка» с реквизитами «Контрагент», «АдресДоставки», «Комментарий» и табличная часть «Товары» с колонками «Номенклатура» и «Количество».
...
2. Создайте несколько доставок, распределите их между двумя курьерами.
3. Настройте в мобильном приложении подключение к центральной базе, убедитесь, что при синхронизации в приложение поступили только доставки выбранного курьера.
