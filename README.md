...
1. В мобильном приложении из [практического задания к занятию 15–1](https://github.com/netology-code/onec-mid-homeworks/blob/main/MROC/homework-15-3.md) создайте документ «Доставка» с реквизитами «Контрагент», «АдресДоставки», «Комментарий» и табличная часть «Товары» с колонками «Номенклатура» и «Количество».
